...
class LLMQuestionApp {
    ...
    this.availableQuestions = Array.from({ length: 54 }, (_, i) => i + 1);
    ...
    this.queuedIndex = null; // for queued navigation during in-flight load
        ...
        this.pathDefinitions = {
            ...
            generation: { label: 'Generation Strategies', difficulty: 'intermediate', questions: [53,5,6,12,23,38] },
