      ...
      <div class=\"bg-indigo-50 p-4 rounded-lg border border-indigo-200\">
        <h4 class=\"font-semibold text-indigo-900 mb-1\">📚 Recommended reading</h4>
            <ul class=\"text-xs text-indigo-800 list-disc ml-5 space-y-0.5\">
              <li><a class=\"underline hover:no-underline\" href=\"index.html#question-6\"><b>Q06</b>: Temperature & decoding</a></li>
              <li><a class=\"underline hover:no-underline\" href=\"index.html#question-15\"><b>Q15</b>: Prompt engineering patterns</a></li>
              <li><a class=\"underline hover:no-underline\" href=\"index.html#question-38\"><b>Q38</b>: Chain-of-Thought prompting</a></li>
            </ul>
      </div>
    ...
    html: `
      <div class=\"space-y-6\">
        <div class=\"bg-gradient-to-r from-indigo-50 to-sky-50 p-4 rounded-lg border border-indigo-200\">
          ...
          <p class=\"text-[11px] text-gray-600 mt-2\">Pipeline: word-match counts → (optional) instruction bias → (optional) few-shot similarity boosts → softmax(T).</p>
        </div>
        <div class=\"grid md:grid-cols-3 gap-4\">
          ...
          <div class=\"bg-white border rounded-lg p-4\">
            ...
            <button id=\"q41-sim\" type=\"button\" class=\"mt-2 text-[11px] px-2 py-1 rounded border bg-white hover:bg-gray-50\" aria-label=\"Run sampling stability simulation\">Stability sample (20 draws)</button>
            <div id=\"q41-sim-out\" class=\"mt-2 text-[10px] text-gray-600 space-y-1\" aria-live=\"polite\"></div>
          </div>
          <div class=\"bg-white border rounded-lg p-4\">
