...
/**
 * OptimizationBasicsSection (Phase 5)
 * 
 * Teaches core optimization principles for agentic search.
 * Split from original OptimizationSection for better pacing.
 * 
 * Structure:
 * 1. Introduction - Why optimization matters
 * 2. Agentic Strategies - McKinsey insights
 * 3. FEED Framework - 4 interactive pillar cards
 * 4. JSON-LD Critical Callout
 * 5. Metrics Panel - Real conversion data
 * 6. Limitations Panel - What breaks and why
 * 7. Call-to-Action - Continue to platform strategies
 */
export function OptimizationBasicsSection() {
  return (
...
{`<script type="application/ld+json">
{
  ...
  "aggregateRating": {
    ...
    "reviewCount": "247"                    ← How many reviews
      ...
      {/* Call to Action - Continue to Platform Strategies */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-xl font-bold text-text-primary mb-3">
              Ready for Platform-Specific Strategies?
            </h4>
            <p className="text-text-secondary mb-4 leading-relaxed">
              You've learned the universal FEED framework. In the next section, we'll dive into 
              <span className="font-semibold text-text-primary"> platform-specific optimization</span>: 
              how ChatGPT uses Bing, what Gemini requires, tracking agent traffic, and preparing for 
              the monetization timeline.
            </p>
            <p className="text-text-muted text-sm italic">
              → Continue to "Platform Strategies" for deep dives on ChatGPT/Bing, analytics setup, 
              industry insights, and the 2025-2028 roadmap.
            </p>
          </div>
        </div>
      </motion.div>
