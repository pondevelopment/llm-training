...
# Multi-Agent Frameworks Tutorial - Build Script
...
# 4. Run the build
echo "🔨 Building..."
npm run build -- --base='/tutorials/multi-agent-frameworks/dist/'
...
if [ -f "dist/index.html" ]; then
    ...
    echo ""
    echo "🌐 Preview at: http://127.0.0.1:5501/tutorials/multi-agent-frameworks/dist/index.html"
else
